...
import com.jyt.terminal.support.CollectionKit;
import com.jyt.terminal.support.StrKit;
import com.jyt.terminal.support.ToolBoxException;
...
public class Convert {
	...
	public static String fieldEnumTransfer(Object field,String simpleName) {
		if(field==null) return null;
		 Map<Object, Object> enumMap = BitEnum.HRU_ENUM_MAP.get(simpleName);
		if(enumMap!=null) {
			 return (String)enumMap.get(field );
		}else {
			return null;
		}
	}
