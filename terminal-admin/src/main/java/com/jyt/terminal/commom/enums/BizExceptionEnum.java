...
public enum BizExceptionEnum implements ServiceExceptionEnum {
     ...
     * 代理商
     */
    AGENCY_ALREADY_REG(601, "AGENCY_HAS_ALREADY_REGISTERED"),//该用户已经注册
    AGENCY_PHONE_IS_NULL(602, "AGENCY_PHONE_IS_NULL"),//该手机号已经注册
    AGENCY_PHONE_ALREADY_REGISTERED(603, "AGENCY PHONE ALREADY REGISTERED"),//该手机号已经注册
    AGENCY_EMAIL_IS_NULL(604, "AGENCY_EMAIL_IS_NULL"),//该邮箱已经注册
    AGENCY_EMAIL_ALREADY_REGISTERED(605, "AGENCY EMAIL ALREADY REGISTERED"),//该手机号已经注册
    AGENCY_NAME_IS_NULL(606, "AGENCY_NAME_IS_NULL"),//该邮箱已经注册
    AGENCY_NAME_ALREADY_REGISTERED(607, "AGENCY NAME ALREADY REGISTERED"),//该手机号已经注册
