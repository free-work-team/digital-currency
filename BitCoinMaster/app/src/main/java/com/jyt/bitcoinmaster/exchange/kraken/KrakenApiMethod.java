...
public enum KrakenApiMethod {
    ...
    WITHDRAWINFO("WithdrawInfo", true),
    WITHDRAWSTATUS("WithdrawStatus", true),
    DEPOSITMETHODS("DepositMethods", true),
    DEPOSITADDRESSES("DepositAddresses", true),
    DEPOSITSTATUS("DepositStatus", true),
    QUERYORDERS("QueryOrders", true),
