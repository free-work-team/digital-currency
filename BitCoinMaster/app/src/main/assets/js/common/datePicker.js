    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                lcalendar_cancel.addEventListener('touchstart', btnClose);
                ...
                //-------------------------------------------------------------
                lcalendar_cancel.addEventListener('click', btnClose);
            ...
            function gearTouchMove(e) {
                ...
                var target = e.target;
                while (true) {
                    if ((target==null) || !target.classList.contains("gear")) {
                        target = target.parentElement;
                    } else {
                        break
                    }
          ...
          _self.trigger&&_self.trigger.addEventListener('click', {
                "ym": popupYM,
                "date": popupDate,
