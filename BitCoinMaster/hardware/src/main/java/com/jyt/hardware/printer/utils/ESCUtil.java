...
public class ESCUtil {
	...
	public static final byte CAN = 0x18;// Canceled (cancel print data in page mode) //初始化打印机 
	public static byte[] init_printer() { 
		byte[] result = new byte[2]; result[0] = ESC; 
		result[1] = 0x40; return result; 
	} 
	//打印浓度指令 
...
//	}
	...
	public static byte[] PrintDiskImagefile(int[] var0, int var1, int var2) {
		byte[] var4;
		if ((var1 = (var4 = (new QRCodeInfo()).getBMPImageFileByte(var0, var1, var2)).length) == 0) {
			return null;
		} else {
	...
	public static byte[] setCodeSystemSingle(byte charset){ 
		...
		result[0] = ESC; 
		result[1] = 0x74;
		result[2] = charset; return result; 
	} 
	/** * 设置多字节字符集 */ 
	...
	// 字体的大小 // 0:正常大小 1:两倍高 2:两倍宽 3:两倍大小 4:三倍高 5:三倍宽 6:三倍大小 // 7:四倍高 8:四倍宽 9:四倍大小 10:五倍高 11:五倍宽 12:五倍大小
