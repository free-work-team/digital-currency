...
(function () {
    ...
    $('.fixed-table-footer table tbody').find("tr").find("td").eq(0).hide();
    $('.fixed-table-footer table tbody').find("tr").find("td").eq(1).css('width','210px');
    }
    window.BSTable = BSTable;

    BSTable.BSTableDefaltParam = {
        contentType: "application/x-www-form-urlencoded",
