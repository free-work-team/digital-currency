...
//	}
	 ...
	 * @return
	 */
	public static Map<String, Object> toCamelCase(Map<String, Object> sourceMap) {
		if(isEmpty(sourceMap)) {
			return new HashMap<String, Object>();
		}
		Map<String, Object> caseMap = new HashMap<String, Object>();
		for(Map.Entry<String, Object> entry : sourceMap.entrySet()) {
			caseMap.put(CaseFormat.LOWER_UNDERSCORE.to(CaseFormat.LOWER_CAMEL, entry.getKey()), entry.getValue());
		}
		return caseMap;
	}
