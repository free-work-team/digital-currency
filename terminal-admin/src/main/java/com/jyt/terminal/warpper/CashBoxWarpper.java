...
public class CashBoxWarpper extends LanBaseControllerWarpper{
	
    public CashBoxWarpper(Object list) {
        super(list);
    }
	...
	protected void warpTheMap(String currentType,Map<String, Object> map) {
		...
		map.put("statusDesc", CashBoxStatus.getName(currentType,(Integer) map.get("status")));
	}
}
