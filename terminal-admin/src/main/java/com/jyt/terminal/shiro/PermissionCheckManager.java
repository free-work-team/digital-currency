...
import com.jyt.terminal.service.ICheck;
...
public class PermissionCheckManager {
    private final static com.jyt.terminal.shiro.PermissionCheckManager me = new com.jyt.terminal.shiro.PermissionCheckManager();

    private ICheck defaultCheckFactory = SpringContextHolder.getBean(ICheck.class);

    public static com.jyt.terminal.shiro.PermissionCheckManager me() {
        return me;
    }
