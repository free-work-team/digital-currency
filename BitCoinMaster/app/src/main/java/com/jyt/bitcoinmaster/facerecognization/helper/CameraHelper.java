    ...
    public void start() {
        synchronized (this) {
            ...
            try {
                ...
                mPreBuffer = new byte[previewSize.width * previewSize.height * 3 / 2];//首先分配一块内存作为缓冲区，size的计算方式见第四点中
                ...
                public void onPreviewFrame(byte[] bytes, Camera camera) {
                    ...
                    cameraListener.onPreview(bytes,mCamera);
                }
            });
...
//            }
//            mCamera.addCallbackBuffer(nv21);//将此缓冲区添加到预览回调缓冲区队列中
//            cameraListener.onPreview(nv21, mCamera);
//        }
    }
